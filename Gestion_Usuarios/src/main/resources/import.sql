...
insert into usuario_perfil values (1,GETDATE(),'',2,1)
insert into usuario_perfil values (1,GETDATE(),'',2,2)
insert into usuario_perfil values (1,GETDATE(),'',2,3)
insert into usuario_perfil values (1,GETDATE(),'',2,4)
insert into usuario_perfil values (1,GETDATE(),'',2,5)
insert into usuario_perfil values (1,GETDATE(),'',2,6)
insert into usuario_perfil values (1,GETDATE(),'',2,7)
insert into usuario_perfil values (1,GETDATE(),'',2,8)
