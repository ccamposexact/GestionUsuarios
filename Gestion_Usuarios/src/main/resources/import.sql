insert into permisos (nombre, descripcion) values ('ROLE_CREADOR DE PERFILES','CREAR PERFILES DE USUARIO')
insert into permisos (nombre, descripcion) values ('ROLE_MODIFICADOR DE PERFILES','MODIFICAR PERFILES DE USUARIO')
insert into permisos (nombre, descripcion) values ('ROLE_MODIFICADOR DE ESTADO DE PERFILES','MODIFICA EL ESTADO DE LOS PERFILES')
insert into permisos (nombre, descripcion) values ('ROLE_ASIGNADOR DE PERFILES','ASIGNAR PERFILES A UN USUARIO')
insert into permisos (nombre, descripcion) values ('ROLE_CREADOR DE PERMISOS','CREAR PERMISOS DE UN USUARIO')
insert into permisos (nombre, descripcion) values ('ROLE_MODIFICADOR DE PERMISOS','MODIFICAR PERMISOS DE USUARIO')
insert into permisos (nombre, descripcion) values ('ROLE_ASIGNADOR DE PERMISOS','ASIGNAR PERMISOS A UN PERFIL')
insert into permisos (nombre, descripcion) values ('ROLE_QUITAR PERMISOS','QUITAR PERMISOS A UN PERFIL')
insert into permisos (nombre, descripcion) values ('ROLE_CREAR USUARIOS','CREA USUARIOS CON UN PERFIL')
insert into permisos (nombre, descripcion) values ('ROLE_MODIFICADOR DE ESTADO DE USUARIOS','MODIFICA EL ESTADO')
insert into permisos (nombre, descripcion) values ('ROLE_MODIFICADOR USUARIOS','MODIFICA LOS DATOS DEL USUARIO')
...
insert into usuarios (activo, nombre, apellido, dni, matricula, correo, username, password) values (1,'ORLANDO','HEREDIA',12345698,'S46697','oheredia@exact.com.pe','oheredia','$2a$04$GKk2hQxmmUAyVqGQM3I7R.6Ua9av7/7XNz4kDE8ODzmVOFDnTxuEK')
