...
insert into usuarios (activo, nombre, apellido, dni, matricula, correo, username, password) values (1,'ERNST','ROJAS',79461389,'EROJAS','rsantos@exact.com.pe','erojas','$2a$04$95zHAMbf4jybXzbVSg0Xu.T1uEX.pgNpTNw1l539ntc4laRLvynYO')
